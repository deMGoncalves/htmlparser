...
export default f.cond([nodeIsRemoved, removeNode], [nodeIsAdded, appendNode], [parentIsRoot, restrictNode], [stateAreDifferent, replaceNode], [stateAreEqual, doNothing], [nodeAreCustom, restrictAttributes], [nodeAreDifferent, replaceNode], [nodeAreEqual, restrictNode], [textContentAreDifferent, setTextContent]);
